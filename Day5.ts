...
let transports: string[] = ["Kawasaki H2r", "Lamborghini Sian", "Cervelo Bicycle"];
...
let Guests: string[] = ["Mark Zuckerberg", "Elon Musk", "Bill Gates"];
